 ...
 * Use the [PublishAnnouncementFragment.newInstance] factory method to
...
class PublishAnnouncementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PublishAnnouncementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PublishAnnouncementFragment().apply {
